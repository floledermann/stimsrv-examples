...
This function gets passed the following parameters:
- ctx2d: A CanvasContext2D drawing context
- condition: the current condition
- context: The task context
- stimsrvAPI: The stimsrvAPI object (for sending warnings, loading resources etc.)
...
*/
function renderText(ctx2d, condition, context, stimsrvAPI) {
  
  ctx2d.textAlign = "center";
  ctx2d.font = `${condition.fontSize}px ${condition.fontFamily}`;
